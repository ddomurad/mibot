...
void SettingsForm::restore()
{
    ...
    ui->lineEdit_picture->setText(AppSettings::GetKey(AppSettings::Connection_Picture_Service).toString());
...
void SettingsForm::on_lineEdit_picture_textChanged(const QString &arg1)
{
    AppSettings::SetKey(AppSettings::Connection_Picture_Service, QVariant(arg1));
}
