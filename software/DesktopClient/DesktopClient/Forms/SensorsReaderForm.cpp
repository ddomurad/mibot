...
void SensorsReaderForm::onSensorData(RoverSensors sensors)
{
    ...
    ui->tableWidget->setItem(0,0, new QTableWidgetItem("Acc"));
    ui->tableWidget->setItem(0,1, new QTableWidgetItem(QString("[%1,%2,%3]")
                    .arg(sensors.arduinoSensors.acc[0])
                    .arg(sensors.arduinoSensors.acc[1])
                    .arg(sensors.arduinoSensors.acc[2])));

    ui->tableWidget->setItem(1,0, new QTableWidgetItem("Mag"));
    ...
    ui->tableWidget->setItem(2,0, new QTableWidgetItem("US"));
    ui->tableWidget->setItem(2,1, new QTableWidgetItem(QString::number(sensors.arduinoSensors.us)));
    ...
    ui->tableWidget->setItem(3,0, new QTableWidgetItem("Analog"));
    ui->tableWidget->setItem(3,1, new QTableWidgetItem(analogString));

    ui->tableWidget->setItem(4,0, new QTableWidgetItem("CPU_TEMP"));
    ui->tableWidget->setItem(4,1, new QTableWidgetItem(QString::number(sensors.systemSensors.cpu_temp)));

    ui->tableWidget->setItem(5,0, new QTableWidgetItem("CPU"));
    ui->tableWidget->setItem(5,1, new QTableWidgetItem(QString("%1 / %2")
                                                       .arg(sensors.systemSensors.cpu_usage_server)
                                                       .arg(sensors.systemSensors.cpu_usage_total)));

    ui->tableWidget->setItem(6,0, new QTableWidgetItem("MEMORY"));
    ui->tableWidget->setItem(6,1, new QTableWidgetItem(QString("%1 / %2 / %3")
